...
class PublicApplicationCreateSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        with transaction.atomic():
            ...
            if not created:
                # This endpoint is unauthenticated: anyone who knows a
                # candidate's email could otherwise overwrite their stored
                # contact details. Only fill in fields that are still blank.
                update_fields = []
